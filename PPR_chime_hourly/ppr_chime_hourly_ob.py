...
class HourlyTOT:
    def __init__(self, fc: str):
        ...
        self.process_ids = {"Batch Sort - Total": 1003015, "Pack Chuting - Total": 1002969, "Pack Singles - Total": 1002993, "Pack Multis - Total": 1002991, "Flow Sort - Total": 1003051, "Giftwrap": 1003029, "Ship Dock": 1003014, "Customer Returns - Total": 1003026, "V-Returns Pack - Total": 1003056}
        self.exclude_functions = ["Shipping Clerk"]
        self.df_zero = self.find_0_units()

        self.url = ("https://hooks.chime.aws/incomingwebhooks/ca7561f1-a017-481d-8757-235b9ee470cc?token=Um9lRjZuemN8MXxhVWdHVUotUllITmNQeWdnVVZ1Tkx1ZG9HaEh1dWdTeWQ0SGM4VmdBTEhZ")
