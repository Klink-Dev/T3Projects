...
class HourlyTOT:
    def __init__(self, fc: str):
        ...
        self.process_ids = {"Transfer Out Pick - Total": 1003065, "Pick - Total": 1003001, "V-Return Pick - Total": 1003034, "IC/QA/CS": 1003030}
        self.exclude_functions = ["Shipping Clerk"]
        self.df_zero = self.find_0_units()

        self.url = ("https://hooks.chime.aws/incomingwebhooks/1a5e4665-01dc-4694-9216-e6e358a45cbd?token=OHJPWldpZ2J8MXxGcV9CaWlpQnFfdWdOUFNteHpUY2wwM1NWUXVnTTFWQkVCWEkwa0k2dGlJ")
